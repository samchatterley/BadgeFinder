...
const { protect, setCurrentUser, requireAuth } = require('../Middleware/authMiddleware');
...
module.exports = (User) => {
    ...
    router.post("/signup", limiter, [
        ...
        body("membershipNumber").notEmpty().withMessage("Membership Number is required"),
    ], asyncHandler(async (req, res) => {
        logger.info("Signup request received. Request body:", req.body);        logger.info("Signup request received");
     ...
     */
    router.post("/signup-secondary", limiter, [
        ...
        const badgesCollection = req.client.db("BadgeFinder").collection("Badges");
    ...
    */
     ...
     */
    router.get('/user/:userId', limiter, protect, setCurrentUser, asyncHandler(async (req, res) => {
