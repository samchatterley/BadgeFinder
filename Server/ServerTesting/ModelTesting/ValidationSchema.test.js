...
describe('ValidationSchema tests', () => {
  it('findOneSchema - valid data', () => {
    ...
    const { error } = findOneSchema.validate(mockUser)
  ...
  it('findByIdSchema - valid data', () => {
    ...
    const { error } = findByIdSchema.validate(mockUser)
    expect(error).toBeUndefined()
  })
  ...
  it('findByEmailSchema - valid data', () => {
    ...
    const { error } = findByEmailSchema.validate(mockUser)
    expect(error).toBeUndefined()
  })
  ...
  it('createSchema - valid data', () => {
    ...
    const { error } = createSchema.validate(mockUser)
    expect(error).toBeUndefined()
  })
  ...
  it('deleteByIdSchema - valid data', () => {
    ...
    const { error } = deleteByIdSchema.validate(mockUser)
    expect(error).toBeUndefined()
  })
  ...
  it('findOneAndUpdateWithOperationsSchema - valid data', () => {
    ...
    const { error } = findOneAndUpdateWithOperationsSchema.validate(mockData)
    expect(error).toBeUndefined()
  })
  ...
  it('registerUserSchema - valid data', () => {
    ...
    const { error } = registerUserSchema.validate(mockUser)
    expect(error).toBeUndefined()
  })
  ...
  it('registerSecondaryUserSchema - valid data', () => {
    ...
    const { error } = registerSecondaryUserSchema.validate(mockUser)
    expect(error).toBeUndefined()
  })
  ...
  it('authenticateUserSchema - valid data', () => {
    ...
    const { error } = authenticateUserSchema.validate(mockUser)
    expect(error).toBeUndefined()
  })
